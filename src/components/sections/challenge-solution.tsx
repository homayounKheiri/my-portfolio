...
function StatementCard({ card }: { card: Card }) {
  ...
  return (
    <div className="group relative flex h-full flex-col rounded-2xl border border-border bg-white px-6 pb-7 pt-10 shadow-[0_10px_36px_-14px_rgba(17,24,39,0.14)] duration-[300ms] sm:px-7 sm:pb-8 sm:pt-11 hover:scale-[1.03]">
      {/* Icon */}
      <span
        className="absolute -top-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-brand to-orange-400 text-white shadow-[0_10px_24px_-8px_rgba(249,115,22,0.65)] transition-transform duration-300 sm:h-14 sm:w-14 group-hover:translate-y-1 group-hover:translate-x-[2px]"
